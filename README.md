...
- 品牌页 `/about`：品牌故事、面料、版型与制作、包装环保与服务承诺。首页横幅、页头和页脚都有入口。
- 帮助中心 `/help`：联系我们、常见问题、配送说明、退换货、尺码指南五个分区，页脚与页头的客服入口都指向对应锚点。
- 购物车增删改。
...
| `/product/:id` | 商品详情 |
| `/about` | 品牌页 |
| `/journal`、`/journal/:id` | 期刊列表与正文 |
| `/help` | 帮助中心，含配送、退换、尺码等说明 |
